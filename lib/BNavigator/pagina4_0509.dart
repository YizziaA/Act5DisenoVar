...
class Pagina4_0509 extends StatelessWidget {
  const Pagina4_0509({Key? key}) : super(key: key);
          ...
          Container(
            ...
            child: ListView(
              children: const <Widget>[
                Card(
                  child: ListTile(
                    title: Text('Yizzia Amahirani Monge Mancinas',
                ...
                Card(
                  child: ListTile(
                    title: Text('a.21308051280509@cbtis128.edu.mx',
                ...
                Card(
                  child: ListTile(
                    title:
                        Text('Autorizaciones', style: TextStyle(fontSize: 20)),
